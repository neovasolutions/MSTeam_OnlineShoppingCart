using OnlineShoppingCart.WebClient.Models;
using System;
...
namespace OnlineShoppingCart.WebClient.Controllers
{
    public class HomeController : Controller
    {
        ...
        public void AddTempData()
        {
            ...
            Session["ProductCategories"] = prodcatList;
        ...
        public PartialViewResult GetAllProducts(int catID)
        {
            AddTempData();
            List<Product> listProducts = (from prod in prodList
                                          where prod.CategoryID == catID
                                          select prod).ToList();
            return PartialView("_Products", listProducts);
        }
